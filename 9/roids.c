...
void roid_draw( const roid_t* roid )
{
  ...
  draw_rectangle( roid->x-roid->width/2.0, roid->y-roid->height/2.0, 
	...
	draw_rectangle( roid->x-roid->width/2.0, roid->y-roid->height/2.0+HEIGHT, 
		  roid->x+roid->width/2.0, roid->y+roid->height/2+HEIGHT,
		  roid->color );
		  
	draw_rectangle( roid->x-roid->width/2.0, roid->y-roid->height/2.0-HEIGHT, 
		  roid->x+roid->width/2.0, roid->y+roid->height/2-HEIGHT,
		  roid->color );
	draw_rectangle( roid->x-roid->width/2.0+WIDTH, roid->y-roid->height/2.0, 
		  roid->x+roid->width/2.0+WIDTH, roid->y+roid->height/2,
		  roid->color );
		  
	draw_rectangle( roid->x-roid->width/2.0+WIDTH, roid->y-roid->height/2.0+HEIGHT, 
		  roid->x+roid->width/2.0+WIDTH, roid->y+roid->height/2+HEIGHT,
		  roid->color );
  ...
  /* TODO: 
     ...
     1x1 world correctly.
  */
    draw_rectangle( roid->x-roid->width/2.0, roid->y-roid->height/2.0,roid->x+roid->width/2.0, roid->y+roid->height/2,roid->color );
...
int shot_roid_hit( const shot_t* shot, const roid_t* roid )
{
   ...
   */
   ...
   float d=sqrt(pow(shot->x-roid->x,2)+pow(shot->y-roid->y,2));
   float dr=sqrt(pow(roid->width/2,2)+pow(roid->height/2,2));
