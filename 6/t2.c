...
intarr_t* intarr_load_json( const char* filename ){
  ...
  printf("len=%d,check2=%d,check3=%d,check4=%d,count=%d,check(count)=%d,tk2=%s,first20=%.20s...],last20=[...%.30s.\n",ia->len,check2,check3,check4,count,ia->len*(ia->len-1)/2,tk2,st2,st2+strlen(st2)-30);
  if(ia->len>4){
